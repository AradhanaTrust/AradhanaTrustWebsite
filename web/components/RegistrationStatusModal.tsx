        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
                ...
                <motion.div
                    ...
                    className="relative w-full max-w-lg bg-[#FDFBF7] rounded-2xl sm:rounded-3xl shadow-2xl border-[3px] sm:border-[4px] border-double border-[#D4AF37]/40 z-10 max-h-[85vh] sm:max-h-[90vh] flex flex-col overflow-hidden mx-auto"
                >
                    {/* Background Pattern */}
                    ...
                    <div className="p-5 sm:p-8 flex flex-col items-center text-center relative z-10 overflow-y-auto custom-scrollbar">
                        {/* Status Icon */}
                        <motion.div
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                        ...
                        >
                            ...
                            {isSuccess ? (
                                <CheckCircle2 className="w-20 h-20 sm:w-24 sm:h-24 text-[#D4AF37] relative z-10 drop-shadow-lg" />
                            ) : (
                                <XCircle className="w-20 h-20 sm:w-24 sm:h-24 text-red-500 relative z-10 drop-shadow-lg" />
                            )}
                        </motion.div>
                        ...
                        >
                            <h2 className="font-cinzel-decorative font-bold text-2xl sm:text-4xl text-[#5D4037]">
                                {title || (isSuccess ? "Success" : "Failed")}
                            </h2>
                            
                            <p className="text-base sm:text-lg text-[#8D6E63] font-serif leading-relaxed px-2 sm:px-4">
                                {message}
                            </p>
                            ...
                            <div className="pt-4 space-y-3 flex flex-col items-center">
                                {receiptUrl && isSuccess && (
                                    <a
                                        ...
                                        className="w-full sm:w-3/4 h-12 px-4 sm:px-6 bg-gradient-to-b from-[#F2C96D] to-[#9E731C] text-white font-medium text-base sm:text-lg rounded-xl border border-[#CFA14E] shadow-[inset_0_0_0_2px_#DFA848,inset_0_0_0_3px_#FFF5D1,0_4px_8px_rgba(0,0,0,0.3)] hover:shadow-[0_6px_15px_rgba(212,175,55,0.4)] hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 drop-shadow-md mx-auto"
                                        onClick={onClose}
                                    >
