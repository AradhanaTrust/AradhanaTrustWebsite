        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-6">
                ...
                <motion.div
                    ...
                    className="relative w-full max-w-lg bg-[#FDFBF7] rounded-3xl shadow-2xl overflow-hidden border-[4px] border-double border-[#D4AF37]/40 z-10"
                >
                    {/* Background Pattern */}
                    ...
                    <div className="p-8 sm:p-10 flex flex-col items-center text-center relative z-10 mt-4">
                        {/* Status Icon */}
                        <motion.div
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                        ...
                        >
                            ...
                            {registrationNo && isSuccess && (
                                <div className="mt-8 mb-6 p-4 bg-gradient-to-r from-transparent via-[#D4AF37]/10 to-transparent border-y border-[#D4AF37]/20">
                            ...
                            <div className="pt-6 space-y-4">
                                {receiptUrl && isSuccess && (
                                    <a
                                        ...
                                        className="w-full h-14 px-8 bg-gradient-to-b from-[#F2C96D] to-[#9E731C] text-white font-medium text-lg rounded-xl border border-[#CFA14E] shadow-[inset_0_0_0_2px_#DFA848,inset_0_0_0_3px_#FFF5D1,0_4px_8px_rgba(0,0,0,0.3)] hover:shadow-[0_6px_15px_rgba(212,175,55,0.4)] hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-3 drop-shadow-md"
                                        onClick={onClose}
                                    >
                                ...
                                <button
                                    onClick={onClose}
                                    className={`w-full h-14 px-8 font-medium text-lg rounded-xl transition-all duration-300 font-serif ${!isSuccess || !receiptUrl 
                                        ? "bg-gray-100 text-[#5D4037] border-2 border-gray-200 hover:bg-gray-200" 
                                        : "bg-transparent text-[#8D6E63] hover:text-[#5D4037] hover:bg-[#D4AF37]/5"}`}
                                >
                                    {isSuccess ? "Return to Events" : "Close"}
                                </button>
                            </div>
                        </motion.div>
                    </div>
